    ...
    <div className="space-y-4">
      ...
      {filtered.length === 0 ? (
        <div className="rounded-lg border border-paper-200 bg-paper-50 p-8 text-center">
          <p className="text-ink-500">No se encontraron exámenes.</p>
        </div>
      ) : (
            ...
            <tbody className="divide-y divide-paper-200">
              {filtered.map((exam) => (
                ...
                >
                  ...
                  <td className="px-4 py-3 text-ink-600">{exam.categoria}</td>
                  <td className="px-4 py-3 text-ink-600">{exam.tipo_muestra}</td>
                  <td className="px-4 py-3 text-right font-variant-numeric tabular-nums text-ink-900">
